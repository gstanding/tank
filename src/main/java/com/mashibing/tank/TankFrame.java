...
//    Tank tank = new Tank(200, 500, direction, Group.GOOD, this);
    ...
    public List<AbstractTank> badTanks = new ArrayList<>();
    public List<AbstractExplode> explodes = new ArrayList<AbstractExplode>();

//    GameFactory gameFactory = new DefaultFactory();
    public GameFactory gameFactory = new RectFactory();
    AbstractTank tank = gameFactory.createTank(200, 500, direction, Group.GOOD, this);
            ...
            switch (keyCode) {
                ...
                case KeyEvent.VK_CONTROL:
                    ...
                    try {
                        ...
                        FireStrategy<AbstractTank> goodFireStrategyInstance = (FireStrategy<AbstractTank>)method.invoke(Class.forName(goodFireStrategy));
                        tank.fire(goodFireStrategyInstance);
